// ==================== login.js – YOU (Estático, sem animação) ====================
(function () {
  ...
  waitForReady(function () {
    ...
    if (loginFormEl && !document.getElementById('forgotPasswordLink')) {
      ...
      document.getElementById('forgotPasswordBtn').addEventListener('click', function (e) {
        e.preventDefault();
        if (typeof window.abrirRedefinicaoSenha === 'function') window.abrirRedefinicaoSenha();
        else showToast('Redefinição de senha indisponível.', 'error');
      });
    }
    ...
    console.log('🔑 Login YOU estático pronto.');
  });
})();